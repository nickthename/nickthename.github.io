...
- The game cartridge can be obtained second-hand the same way as a console, and a standard Super Smash Bros. cartridge is all you need to play. Many players opt to use an [EverDrive](https://krikzz.com/our-products/cartridges/) or equivalent instead, which can hold any number of N64 games and makes it possible to play mods like 19XX on console.
- There are a ton of possible controller options, see the [controller guide](/guides/controllers.html) for details. Original N64 controllers work fine, but you may want to [lubricate the stick](/guides/controllers.html#lubricants) to help reduce wear.
